/**
 * Created by xiaoxiaoying on 2018/8/14.
 */
...
function add(mimeType, extension) {
    mimeMap.set(mimeType, extension);
    extensionMap.set(extension, mimeType);
}
var mime = {
    getType: function (key) {
        return extensionMap.get(key);
    },
    getMime: function (key) {
